<x-app-layout>
  ...
  <x-section.two-column title="Wholesale Nurseries" subtitle="Find nurseries in your state." imagesrc="/images/thundercloud-plum-photo.jpg" imagecaption="Thundercloud plum flowers." :imageRight="false">
    <x-slot:paragraph>
      Needing a certain hard to find plant? Search for it on our site, and save it for later. See what nurseries grow, and find what plants are most common.
    </x-slot:paragraph>
  </x-section.two-column>
